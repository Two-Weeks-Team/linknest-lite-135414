...
> Simple bookmark saver with instant search – no login, no AI, just fast access.

---

## Overview

People lose time trying to locate a saved web link among thousands of unsorted bookmarks.
...
services:
  - name: api
    github:
      repo: Two-Weeks-Team/linknest-lite
      branch: master
